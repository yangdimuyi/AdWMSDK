...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/yangdimuyi/AdWMSDK.git", :tag => "#{spec.version}" }
  spec.requires_arc = true
  spec.default_subspec = 'AdSDk'
  
  spec.subspec 'AdSDk' do |ss|
    ss.resource  = "WMSDK/adwangmai_sdk.bundle"
    ss.ios.vendored_frameworks = 'WMSDK/AdWangMaiSDK.framework'
